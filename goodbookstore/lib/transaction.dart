...
import 'package:reward/dummies/transaction.dart';
class Transaction {
  String name;
  double point;
  int createdMillis;
...
List<Transaction> transactions = List.generate(20, (index) {
  bool isBook = random.nextBool();
  String name = isBook ? "Harry Potter" : "Sherlock Holmes" : "KBBI";
  double point = isBook ? 30000 : (random.nextInt(9) + 1) * 10000.0;
  return Transaction(
      name: name,
      point: point,
        ...
        child: Row(
          children: <Widget>[
            ...
            Container(
              padding: EdgeInsets.symmetric(horizontal: 16, vertical: 16),
              child: Text(
                NumberFormat("###,###,#### Rupiah").format(transaction.point),
                style: Theme.of(context)
                    .textTheme
                    .subtitle2
